...
def upgrade() -> None:
    ...
    sa.Column('modifed_at', sa.TIMESTAMP(timezone=True), nullable=True),
    ...
    op.create_index(op.f('ix_users_modifed_by'), 'users', ['modifed_by'], unique=False)
    ...
    op.create_index(op.f('ix_products_modifed_by'), 'products', ['modifed_by'], unique=False)
    ...
    op.create_index(op.f('ix_tanks_modifed_by'), 'tanks', ['modifed_by'], unique=False)
    ...
    op.create_index(op.f('ix_operations_modifed_by'), 'operations', ['modifed_by'], unique=False)
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.SMALLINT(), server_default=sa.text("nextval('categories_id_seq'::regclass)"), autoincrement=True, nullable=False),
